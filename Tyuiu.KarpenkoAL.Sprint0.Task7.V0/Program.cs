using Tyuiu.KarpenkoAL.Sprint0.Task7.V0.Lib;

Console.Title = "Спринт #0 | Выполнил: Карпенко А. Л. | ИБКСб-25-1";
...
{
    Console.WriteLine("Ошибка! Исходные массивы содержат разное количество элементов");
}
Console.ReadKey();
